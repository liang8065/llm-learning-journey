...
## Day 22 (2026-04-03) 🎯 — 高级 RAG 技术

### 📋 今日任务
1. **Part 1: HyDE 假设性文档嵌入** — 原理 + 完整代码实现 ✅
2. **Part 2: Multi-query 多路检索** — 原理 + 完整代码实现 ✅
3. **Part 3: Self-RAG 自我反思** — 原理 + 完整代码实现 ✅
4. **Part 4: 三种 RAG 策略效果对比** — 同一问题对比测试 ✅

### 📝 今日笔记
- **HyDE**: 让 LLM 先生成假设答案再检索，语义匹配度大幅提升
- **Multi-query**: 多角度生成查询语句，提升检索覆盖率
- **Self-RAG**: 自我评估检索质量，不满意则重新检索，迭代改进
- 所有代码均为 LangChain 1.0+，使用 LCEL 表达式链，完整可运行

### 收获与反思
- 三种高级 RAG 策略各有优势，日常场景按需选择
- HyDE 适合问题和知识库语义差异大的场景
- Multi-query 适合全面覆盖避免遗漏
- Self-RAG 适合对质量要求高的场景
- 今天的代码已全部在 GitHub 上，可以直接运行实验

### 用时统计
- 实际用时：1.5-2小时

### 相关文件
- 学习内容: [week-04/day-22/Day22-学习内容.md](week-04/day-22/Day22-学习内容.md)
- GitHub: https://github.com/liang8065/llm-learning-journey

---

## Day 21 (2026-04-03) 🎯 — Week 3 总结 + 项目中期检查

### 📋 今日任务
1. **Week 3 知识回顾** — 复杂 Agent、工具生态、流式、高级 Prompt、安全 ✅
2. **项目进度评估** — 名著改写器 + 学习知识库进度检查 ✅
3. **阶段二总结与下一阶段规划** ✅

### 📝 今日笔记
- Week 3 涵盖了 Agent 进阶、工作流编排、流式输出、高级 Prompt、安全加固
- 能力雷达：Prompt 80%, LangChain 75%, RAG 70%, Agent 65%, 测试 60%, 部署 50%, 微调 30%
- 已进入阶段三（项目实战期）

### 收获与反思
- 多 Agent 协作让系统能力大幅提升
- Agent 安全是不可忽视的重点（Prompt 注入、工具滥用、限流）
- 流式输出用户体验显著改善
...
### 相关文件
- 学习内容: [week-04/day-21/Day21-学习内容.md](week-04/day-21/Day21-学习内容.md)

**重要约定**
- 所有学习计划推送前必须细化，LangChain 使用 1.0+ 版本
- 每日必须包含完整可运行的示例代码，且全部推送到 GitHub 仓库
